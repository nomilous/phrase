...
exports.createClass = function(root) {
  ...
  PhraseNode = (function() {
        ...
        get: function() {
          return function(changes) {
            ...
            if (changes.hooks != null) {
              return localOpts.hooks.update(changes.hooks);
            }
          };
        }
      });
    ...
    PhraseNode.prototype.getChanges = function(vertex) {
      var changes, currentFn, currentTimeout, from, hookType, latestFn, latestTimeout, property, to, _base, _base1, _i, _j, _len, _len1, _ref, _ref1;
      changes = void 0;
      _ref = ['fn', 'timeout', 'leaf'];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        property = _ref[_i];
        from = (function() {
          try {
