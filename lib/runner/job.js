...
var deferred, sequence, _ref;

_ref = require('also'), deferred = _ref.deferred, sequence = _ref.sequence;

exports.createClass = function(root) {
  var Job, context, inject, notice, util;
  inject = root.inject, context = root.context, util = root.util;
  notice = context.notice;
  return Job = (function() {
    function Job(opts) {
      var localOpts, param, property, _fn, _i, _len, _ref1,
        _this = this;
      if (opts == null) {
        opts = {};
      }
      opts.uuid || (opts.uuid = util.uuid());
      ...
      _ref1 = ['notice', 'uuid', 'steps', 'deferral', 'progress'];
    ...
    Job.prototype.run = deferred(function(running) {
      var message,
        _this = this;
      if (this.skipped) {
      ...
      return this.notice.phrase(message.update, message).then(function() {
        ...
        return sequence(_this.steps.map(function(step) {
          ...
          injectionConfig = {
            ...
            onError: function(done, context, error) {
              var intersect, s, skipped, update, _i, _len, _ref1;
              skipped = [];
              _ref1 = _this.steps;
              for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
                s = _ref1[_i];
              ...
              return _this.notice.phrase('run::step:failed', {
                update: 'run::step:failed',
                "class": _this.constructor.name,
                jobUUID: _this.uuid,
                progress: _this.progress(),
            ...
            afterEach: function(done) {
              if (!(step.skip || step.fail)) {
                ...
                return _this.notice.phrase(message.update, message).then(function() {
                  _this.deferral.notify(message);
                  return done();
                });
              }
