...
var BoundryHandler, PhraseTokenFactory, pipeline, sequence, _ref;

_ref = require('also'), sequence = _ref.sequence, pipeline = _ref.pipeline;
...
exports.create = function(root, parentControl) {
  ...
  return function(done, injectionControl) {
    ...
    run = sequence([
      function() {
        return notice.phrase('phrase::edge:create', {
            ...
            function() {
              ...
              return sequence((function() {
                ...
                for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
                  referPhrase = _ref1[_i];
                  _results.push((function(referPhrase) {
                    return function() {
                      return pipeline([
                        function() {
                          return notice.phrase('boundry::edge:create', {
