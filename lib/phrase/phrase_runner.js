...
api = {
  run: function(root, opts, params) {
    var context, graph, notice, running, uuid;
    if (opts == null) {
      opts = {};
    }
    if (params == null) {
  ...
  getSteps: function(root, opts, running) {
    var afters, befores, context, count, depth, getting, graph, leaves, recurse, set, start, steps, uuid;
    context = root.context;
    graph = context.graph;
    uuid = opts.uuid;
    getting = defer();
