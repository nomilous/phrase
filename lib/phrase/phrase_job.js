...
exports.create = function(root) {
  ...
  return PhraseJob = (function() {
    function PhraseJob(opts) {
      ...
      if (opts.notice == null) {
        throw new Error('PhraseJob requires opts.notice');
      }
    ...
    PhraseJob.prototype.run = function() {
      ...
      this.notice.event(message.state, message).then(function() {
        ...
        return sequence(_this.steps.map(function(step) {
          ...
          injectionConfig = {
            ...
            onError: function(done, context, error) {
              var intersect, s, skipped, state, _i, _len, _ref;
              skipped = [];
              _ref = _this.steps;
              for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                s = _ref[_i];
          ...
          return _this.notice.event(message.state, message).then(function() {
            _this.deferral.notify(message);
