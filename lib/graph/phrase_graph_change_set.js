...
exports.createClass = function(root) {
  ...
  PhraseGraphChangeSet = (function() {
    ...
    PhraseGraphChangeSet.prototype.AtoB = function() {
      var childUUID, doing, hook, newHook, parentUUID, path, target, type, _i, _j, _len, _len1, _ref, _ref1;
      doing = defer();
      if (this.changes.updated != null) {
        for (path in this.changes.updated) {
          target = this.graphA.vertices[this.graphA.paths[path]];
          ...
          if (this.changes.updated[path].hooks != null) {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              ...
              if ((hook != null) && !((hook.fn.from != null) || (hook.timeout.from != null))) {
                ...
                parentUUID = this.graphA.paths[path];
                _ref1 = this.graphA.children[parentUUID];
                for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
                  childUUID = _ref1[_j];
                  this.graphA.vertices[childUUID].hooks[type] = newHook;
                }
              }
            }
          }
