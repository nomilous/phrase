...
exports.createClass = function(root) {
  ...
  PhraseGraphChangeSet = (function() {
    function PhraseGraphChangeSet(graphA, graphB) {
      var changes, newGraph, newUUID, newVertex, parentPath, path, runningGraph, runningUUID, runningVertex, uuid, vertex, _base, _base1, _base2, _base3, _base4, _base5, _base6, _base7, _base8, _base9;
      this.graphA = graphA;
      this.graphB = graphB;
      this.uuid = v1();
      this.changes = {
