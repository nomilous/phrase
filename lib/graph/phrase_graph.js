...
exports.createClass = function(root) {
  ...
  PhraseGraph = (function() {
    ...
    PhraseGraph.prototype.update = function() {
      var create, created, deleted, deletes, doing, newGraph, newUUID, path, runningGraph, runningUUID, runningVertex, update, updated, uuid, vertex, _i, _j, _k, _len, _len1, _len2;
      doing = defer();
      created = [];
      updated = [];
      deleted = [];
